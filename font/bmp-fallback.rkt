...
(define (fallback k t)
  ...
  (blit (string-ref h 0) (+ x  0) (+ y  0))
  (blit (string-ref h 1) (+ x  4) (+ y  0))
  (blit (string-ref h 2) (+ x  8) (+ y  4))
  (blit (string-ref h 3) (+ x 12) (+ y  4))
  (define j (sjis->integer (sjis (nk k t) (nt t))))
  (define l (bytes->hex-string (integer->integer-bytes j 2 #f #t)))
  (blit (string-ref l 0) (+ x  0) (+ y  8))
  (blit (string-ref l 1) (+ x  4) (+ y  8))
  (blit (string-ref l 2) (+ x  8) (+ y 12))
  (blit (string-ref l 3) (+ x 12) (+ y 12)))
